...
#
#********START USER_INPUTS*********
TESTSIGMA_API_KEY=eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiI1OGQxYzE1OC00ZWJiLTRiN2ItODMzNC0xOTQ3N2Y1NjY3ODkiLCJkb21haW4iOiJ0ZXN0c2lnbWF0ZWNoLmNvbSIsInRlbmFudElkIjoyODE3LCJpc0lkbGVUaW1lb3V0Q29uZmlndXJlZCI6ZmFsc2V9.fu5dnOgliiaRF2-J6eMcu_1sZ7ZeaY3ON_g3Uqtbs1RGLlFHIJz9PuiY2YViAukb1b95yAHY8oazSlYkjdXlhw
MAX_WAIT_TIME_FOR_SCRIPT_TO_EXIT=90
JUNIT_REPORT_FILE_PATH=./junit-report-$(date +"%Y%m%d%H%M").xml
BUILD_NO=$(date +"%Y%m%d%H%M")
TESTSIGMA_TEST_PLAN_ID=81626
#********END USER_INPUTS***********
